#2:9
#주택 건축 사업
#기둥과 보를 사용해 벽면 구조물 생성
#기둥과 보는 길이가 1인 선분으로 표현
#기둥은 바닥위에 있거나 보의 한쪽 끝 부분 위에 있거나 또는 다른 기둥 위에 있어야 함
#보는  한쪽 끝 부분이 기둥 위에 있거나 양쪽 끝부분이 다른 보와 동시에 연결되어 있어야 함
#n*n 크기 격자, 각 보나 기둥을 세울때마다 점금 필요
#기둥과 보 삭제 후에도 조건을 만족해야 함, 조건을 만족하지 않으면 작업 무시됨
